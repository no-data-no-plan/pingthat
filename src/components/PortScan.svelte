...
<div class="px-6 sm:px-8 py-6 space-y-6" style="max-width: 48rem; margin: 0 auto;">
  <div class="card">
    <div class="card-body space-y-3">
      ...
      <input id="port-host" type="text" inputmode="url" autocapitalize="off" autocorrect="off" spellcheck="false" bind:value={host} placeholder={t.placeholder} onkeydown={(e) => e.key === 'Enter' && scan()} style="width: 100%;" />
      ...
      <input id="port-custom" type="text" bind:value={customPorts} placeholder={t.customPortsPlaceholder} onkeydown={(e) => e.key === 'Enter' && scan()} style="width: 100%;" />
