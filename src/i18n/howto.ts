  ...
  "my-ip": {
    ...
    es: {
      ...
      steps: [
        ...
        { name: "Copia o comparte", text: "Haz clic en copiar para colocar la IP en el portapapeles y compartirla o depurar." },
      ],
    },
  },
  ...
  "http-headers": {
    ...
    es: {
      ...
      steps: [
        ...
        { name: "Revisa cache y cookies", text: "Mira Cache-Control, ETag, Set-Cookie y headers CORS para depurar cache y comportamiento cross-origin." },
      ],
    },
  },
  ...
  "url-parser": {
    ...
    es: {
      ...
      steps: [
        ...
        { name: "Copia cualquier parte", text: "Haz clic en cualquier componente para copiarlo — útil para URLs canónicas o depuración de redirecciones." },
      ],
    },
  },
