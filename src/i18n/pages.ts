  ...
  "webrtc-leak-test": {
    ...
    es: {
      ...
      seoFeatures: [
        ...
        "Test de alcance STUN (sondea STUN de Google y reporta respuesta)",
  ...
  "password-strength": {
    ...
    es: {
      ...
      useCases: [
        ...
        "Probar si una contraseña cumple las reglas de complejidad de un servicio antes de registrarte — y verificar que las reglas no te empujan a un patrón predecible.",
      ],
      faqHeading: "Preguntas frecuentes",
      faqs: [
  ...
  "email-auth": {
    ...
    es: {
      ...
      howSteps: [
        ...
        "La herramienta consulta los registros DNS SPF, DKIM y DMARC vía Cloudflare DoH y los parsea.",
  ...
  "is-it-down": {
    ...
    es: {
      ...
      howSteps: [
        ...
        "La herramienta corre sondeos de alcance desde múltiples regiones anycast Cloudflare (RFC 4786) y reporta resultados por capa (DNS / TCP / TLS / HTTP).",
  ...
  "http-headers": {
    ...
    es: {
      ...
      howSteps: [
        ...
        "Todas las cabeceras de respuesta se muestran con valores parseados; las cabeceras de seguridad se puntúan contra la base OWASP Secure Headers.",
      ...
      faqs: [
        ...
        { q: "¿Cómo puedo verificar que HTTP/2 o HTTP/3 está siendo usado realmente?", a: "Negociado vía ALPN durante el handshake TLS; protocolo no en cabeceras de respuesta directamente. Señales: curl -v muestra el resultado ALPN; la cabecera alt-svc anuncia disponibilidad de HTTP/3 (h3) para futuras peticiones; el panel Network de DevTools muestra el protocolo por petición. RFC 9114 = HTTP/3 sobre QUIC; RFC 9113 = HTTP/2 sobre TCP." },
      ],
    },
  },
  "whois-lookup": {
    ...
    es: {
      ...
      seoFeatures: [
        ...
        "Listado de nameservers parseado del array 'nameservers' de RDAP",
      ...
      howSteps: [
        ...
        "Revisa el JSON parseado: registrador (con IANA ID), fechas clave, nameservers, códigos de estado EPP (con descripciones breves según RFC 5731).",
        "Usa el contacto de abuso (siempre público según política ICANN) para reportar malware/phishing — el contacto del titular está típicamente censurado bajo la Política de Datos de Registro post-GDPR.",
      ],
      useCasesHeading: "Casos de uso comunes",
      useCases: [
  ...
  "url-parser": {
    ...
    es: {
      ...
      seoFeatures: [
        ...
        "Construido sobre la API URL nativa del navegador — sin dependencias externas, sin round-trip al servidor",
      ],
