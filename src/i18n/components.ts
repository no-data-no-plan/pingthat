...
export const jwtDecoderI18n = {
  en: {
    ...
    signatureNote: "Signature verification requires the secret key, which is not done client-side for security.",
    copy: "Copy",
    copied: "Copied!",
  },
  es: {
    ...
    signatureNote: "La verificaci\u00f3n de la firma requiere la clave secreta, lo cual no se realiza en el lado del cliente por seguridad.",
    copy: "Copiar",
    copied: "\u00a1Copiado!",
  },
} as const;
