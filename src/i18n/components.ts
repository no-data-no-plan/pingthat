...
export const jwtDecoderI18n = {
  ...
  es: {
    ...
    verifyAlgUnsupported: "Algoritmo no compatible",
...
export const webrtcLeakTestI18n = {
  ...
  es: {
    ...
    notSupported: "WebRTC no es compatible con tu navegador.",
...
export const ipv6CheckI18n = {
  ...
  es: {
    ...
    nameservers: "Servidores de Nombres con AAAA",
...
export const emailAuthI18n = {
  ...
  es: {
    ...
    results: "Resultados de Autenticación de Email",
    spfTitle: "SPF (Sender Policy Framework)",
    dmarcTitle: "DMARC (Autenticación de Mensajes Basada en Dominio)",
    dkimTitle: "DKIM (DomainKeys Identified Mail)",
    ...
    tipDmarc: "DMARC indica a los servidores receptores que hacer cuando las verificaciones SPF o DKIM fallan. Una politica de 'reject' o 'quarantine' proporciona protección fuerte contra suplantación.",
...
export const portScanI18n = {
  ...
  es: {
    ...
    colService: "Servicio",
    colStatus: "Estado",
    scanFailed: "El escaneo de puertos falló. Inténtalo de nuevo.",
    invalidPorts: "Puertos no validos. Introduce numeros separados por comas entre 1 y 65535 (max 5).",
    disclaimer: "Esta herramienta usa una sonda HTTP/HTTPS desde un Cloudflare Worker, no un escaneo TCP real. Los puertos HTTP (80, 443, 8080, 8443, etc.) se informan con fiabilidad como Abierto, Cerrado o Filtrado. Los servicios no-HTTP (SSH, FTP, SMTP, bases de datos...) no pueden validarse via HTTP y se informan como No verificable cuando el edge acepta la conexion. Filtrado significa que la conexion expiro.",
  },
} as const;
